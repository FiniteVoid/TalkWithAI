    ...
    <View className="flex-1 justify-center items-center p-0 mx-0">
      <Popover>
        ...
        <PopoverContent
          ...
          className="w-48 flex-col gap-1 p-0"
        >
          <Button
            variant="ghost"
          ...
          <Button
            ...
            className="w-full flex justify-start items-center flex-row gap-2 p-0 !h-16"
            onPress={() =>
              startActivityAsync("com.android.settings.TTS_SETTINGS")
            }
          >
            <Volume1 size={24} className="text-foreground" />
            <Text className="text-sm text-left">Speech Config</Text>
          </Button>
        </PopoverContent>
      </Popover>
      <APIKeyDialog
